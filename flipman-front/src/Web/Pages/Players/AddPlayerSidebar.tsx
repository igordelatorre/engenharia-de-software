...
type Props = {
  isOpen: boolean;
  onClose(): void
  setPlayers: React.Dispatch<React.SetStateAction<ResponsePlayer[]>>
  players: ResponsePlayer[]
};

function AddPlayerSidebar({ isOpen, onClose, setPlayers, players}: Props) {
...
export default AddPlayerSidebar;
